...
const title = 'Adhham'
const description =
  'Building software and exploring engineering through projects, experiments, and writing.'
...
export const siteContent = {
  ...
  writing: {
    title: 'Writing',
    description: `A collection of essays and reflections on systems, software, philosophy, science, and life, published across two distinct spaces: Cogito Ergo Scribo, my writing in English, and Fikuraathu, my writing in Dhivehi.`,
    items: [
      {
